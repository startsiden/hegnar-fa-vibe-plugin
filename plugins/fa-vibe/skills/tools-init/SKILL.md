---
description: First-time setup check. the first time you open a project. The journalist says 'let's start', 'I'm new', 'set this up', or hits an error that looks like a missing tool
---
