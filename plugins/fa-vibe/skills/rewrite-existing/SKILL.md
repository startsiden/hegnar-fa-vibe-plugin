---
description: Port an existing project to the FA Vibe Starter. journalist hands you a folder / git repo and says 'make this Finansavisen-style', 'redo this in our format', 'use my old project as a starting point'
---
