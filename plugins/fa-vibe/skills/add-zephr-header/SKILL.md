---
description: Finansavisen header + footer. journalist says 'add the FA header', 'show the Finansavisen logo', 'make it look like finansavisen.no', 'add the login button'
---
