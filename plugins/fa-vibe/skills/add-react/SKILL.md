---
description: Make a page interactive with React. journalist says 'I want a dashboard', 'it should update live', 'make this filterable', 'an interactive chart', 'the page should react to clicks', 'react-ish', 'an app, not a page'
---
